...
static inline __epi_1xi64 __builtin_epi_zip1_1xi64(__epi_1xi64 v0, __epi_1xi64 v1, unsigned long int vc) {
	...
	__epi_1xi64 v0r = __builtin_epi_vrgather_1xi64(v0, hidx, vc);
	__epi_1xi64 v1r = __builtin_epi_vrgather_1xi64(v1, hidx, vc);
...
static inline __epi_1xi64 __builtin_epi_trn2_1xi64(__epi_1xi64 v0, __epi_1xi64 v1, unsigned long int vc) {
	...
	hidx = __builtin_epi_vadd_1xi64(hidx, vone, vc); // (1, 1, 3, 3, 5, 5, ...)
        ...
        __epi_1xi64 mask = __builtin_epi_vand_1xi64(idx, vone, vc); // (0, 1, 0, 1, 0, ...)
	__epi_1xi1 mmask = __builtin_epi_cast_1xi1_1xi64(mask); // idem, as mask
	res = __builtin_epi_vmerge_1xi64(v0r, v1r, mmask, vc); // should give us what we want ... // check registers - 5 ?!?
        return res;
}
...
static inline __epi_1xi64 __builtin_epi_uzp1_1xi64(__epi_1xi64 v0, __epi_1xi64 v1, unsigned long int vc) {
        ...
        __epi_1xi64 idx = __builtin_epi_vid_1xi64(vc); // (0, 1, 2, 3, ...)
        __epi_1xi64 vone = __builtin_epi_vmv_v_x_1xi64(1, vc);
        __epi_1xi64 hidx = __builtin_epi_vand_1xi64(idx, __builtin_epi_vmv_v_x_1xi64(((vc/2)-1), vc), vc); // (0, 1, 2, ..., 0, 1, 2, ...) // assume vc is a power of 2 // might not be necessary, what happens if gathering non-exsitent lanes ?
